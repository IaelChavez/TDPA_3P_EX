...
class MainActivity : AppCompatActivity() {
    ...
    fun alta(){
        ...
        if(binding.txtNombre.text?.isEmpty() == true &&
            binding.txtNombre.text?.isEmpty() == true &&
            binding.txtMateria.text?.isEmpty() == true &&
            binding.txtCal1.text?.isEmpty() == true &&
            binding.txtCal2.text?.isEmpty() == true){
            binding.txtNombre.error = "Rellena este campo"
            binding.txtMateria.error = "Rellena este campo"
            binding.txtCal1.error = "Rellena este campo"
            binding.txtCal2.error = "Rellena este campo"
        }
        else if(binding.txtNombre.text?.isEmpty() == true ){
            binding.txtNombre.error = "Rellena este campo"
        }
        else if(binding.txtMateria.text?.isEmpty() == true){
            binding.txtMateria.error = "Rellena este campo"
        }
        else if(binding.txtCal1.text?.isEmpty() == true){
            binding.txtCal1.error = "Rellena este campo"
        }
        else if(binding.txtCal2.text?.isEmpty() == true){
            binding.txtCal2.error = "Rellena este campo"
        }
        else{
    ...
    fun buscarAlumno(){
        if(binding.txtId.text?.isEmpty() == true){
            binding.txtId.error = "Rellena este campo"
        }
        else{
            val quer = SQLiteHelper(this, "administracion",null, 1)
            val db = quer.writableDatabase
